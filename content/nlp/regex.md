...
tags:
  ...
  - regex
  - text-processing
summary: "Regular expression fundamentals  -  pattern syntax for text search and processing."
---
...
A regex search function will search through the corpus returning all texts that match the pattern.
...
🚨 RegEx comes in many variants. In this article we will be discussing
**extended regex**.
